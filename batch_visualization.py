...
def main():
    ...
    for subj_id in unique_subjects:
        for session_n in unique_sessions:
            ...
            print('plotting task-evoked response for subject {}'.format(subj_id) +
            ...
            fig, fig_name = vz.visualize(reward_samples.trial_sample, reward_samples.pupil_diameter
             subj_id=subj_id, session_n=session_n,
            reward_code=reward_code, id_str='raw')
