...
def subtractive_baseline_correction(segmented_samples, baseline_interval=500):
    ...
    if bc_pupil_diameter:
        ...
        segmented_samples['z_pupil_diameter'] = bc_pupil_diameter_flattened
    else:
        segmented_samples['z_pupil_diameter'] = np.nan
